    ...
    return (
        <div className="TutoringPopUpWrapper" style={{width:"345px", top:windowTopPosition}}>
            ...
            <div className="ICanTeachPageOneWrapper">
                ...
                <Button onClick={()=>{setPageNumber(2);  setWindowTopPosition('100px')}} style={{marginLeft:'0'}}>Next</Button>
            </div>
            }
            {
                pageNumber === 2 &&
                <div className="ICanTeachPageTwoWrapper">
                    <ICanTeachPageTwo goToNextPage={()=>{setPageNumber(3); setWindowTopPosition('250px')}}/>
                </div>
            }
            {
                pageNumber === 3 &&
